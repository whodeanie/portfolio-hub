  ...
  return (
    <main className="min-h-screen px-6 sm:px-8 py-16 sm:py-24">
      <div className="mx-auto max-w-prose">
        ...
        {/* FEATURED CASE STUDIES (compact discoverable row near the top) */}
        <section className="mt-16 section-rule pt-12">
          <h2 className="font-mono text-xs uppercase tracking-widest text-[var(--muted)]">
            Featured case studies
          </h2>
          <p className="mt-4 text-sm text-[var(--fg)]/65 leading-relaxed">
            Click any card to read the full writeup. Short bullets for each
            project live further down the page.
          </p>
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              {
                title: "MCP RAG Starter",
                tagline: "Production RAG packaged behind a Model Context Protocol server.",
                href: "/work/mcp-rag-starter/",
              },
              {
                title: "Claude Skill Suite",
                tagline: "Four production Claude Agent SDK skills shipping to Amazon KDP.",
                href: "/work/claude-skill-suite/",
              },
              {
                title: "n8n Workflow Library",
                tagline: "41 productized agentic n8n packs covering function calling, RAG, and more.",
                href: "/work/n8n-workflow-library/",
              },
              {
                title: "NBA Predict Pro",
                tagline: "Calibrated ML ensemble plus Llama 3.3 70B risk notes for every pick.",
                href: "/work/nba-playoff-props/",
              },
              {
                title: "FwdThink Federal RAG",
                tagline: "Procurement RAG plus faithfulness eval for a federal agency.",
                href: "/work/fwdthink-rag-procurement/",
              },
              {
                title: "Track Meet Tracker",
                tagline: "Fan facing track and field schedule with iCal feed plus weekly AI brief.",
                href: "/work/track-meet-tracker/",
              },
            ].map((c) => (
              <Link
                key={c.href}
                href={c.href}
                className="group block rounded-lg border border-[var(--rule)] p-4 hover:border-[var(--accent)] transition-colors"
              >
                <div className="flex items-baseline justify-between gap-3">
                  <h3 className="serif text-lg font-medium leading-tight group-hover:text-[var(--accent)] transition-colors">
                    {c.title}
                  </h3>
                  <span
                    aria-hidden
